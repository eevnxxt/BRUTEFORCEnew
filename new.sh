...
pu='\033[37;1m' #putih
ku='\033[33;1m' #kuning
#SUBSCRIBE YT CHANNEL BARU : NOOB BWANG
echo
echo
echo
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo $i" |"$cy"     ANON 77 CYBER TERMUX"$i"                         |"
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR :"$ku"NOOB BWANG[FR13ND8]"$i"                 |"
echo $i" |"$pu" YOUTUBE :"$ku"NOOB BWANG"$i"                         |"
echo $i" |"$pu" THANKS TO :"$cy"~ [MR.X] [MR.G] [MR.T]"$i"           |"
echo $i" |"$cy"            ~ [cyberTEAM] [MR.ZTT] [MR.XxX]"$i"       |"
echo $i" |"$pu" Contack WhatsApp :"$ku" 081285939588"$i"             |"
echo $i" |"$pu" Contack Gmail :"$ku" nabilah1355@gmail.com@gmail.com"$i"|"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
...
echo $i"────────────────────────────────"$i"    |"$cy" R"$i" |"
echo $i"|"$me"18"$i" |"$cy" INSTALL BAHAN DULU       "$i"|"$i"    |"$cy" E"$i" |"
